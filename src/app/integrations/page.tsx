            ...
            {groups.map((group, gi) => (
              ...
              >
                <div className="lg:sticky lg:top-28 lg:self-start">
                  ...
                  <h3 className="mt-2 text-[1.3125rem] leading-[1.2] md:text-[1.625rem] lg:text-h3">
                    {group.heading}
                  </h3>
                  <p className="mt-3 text-body text-grey-600">{group.blurb}</p>
                  <p className="mt-6 hidden text-grey-500 lg:block">
                    <ConnectorLine length={96} arrow crosshair="start" />
                  </p>
                </div>

                <ClippedPanel clip="md" bordered className="bg-grey-200" as="div">
            ...
            {approach.items.map((item, i) => (
              <Reveal key={item.title} delay={i * 60} className="h-full">
                <ClippedPanel
                  clip="sm"
                  bordered
                  className="flex h-full flex-col gap-4 bg-base-2 p-8"
                >
